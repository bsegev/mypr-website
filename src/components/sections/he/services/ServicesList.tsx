...
const services = [
  {
    ...
    title: "יחסי ציבור ותקשורת אסטרטגית",
  ...
  },
  {
    ...
    title: "ניהול רשתות חברתיות, יצירת תוכן וקידום דיגיטלי",
    description: "יצירת אסטרטגיית תוכן שתגלממומן לבלוט – כולל ניהול עמודים ברשתות החברתיות, פיתוח תוכן קריאטיבי, כתיבה שיווקית, עיצוב גרפי וקידום ממומן. אנחנו משלבים בין אורגני לממומן, כדי למקסם מעורבות, חשיפה והנעה לפעולה.",
  ...
  {
    id: "data-strategy",
    title: "פיתוח אסטרטגיה מבוססת נתונים וטכנולוגיה",
    description: "שימוש בבינה מלאכותית (AI), ניתוח מגמות בזמן אמת ויצירת תובנות מדויקות שמאפשרות לקבל החלטות מבוססות נתונים. כלים דיגיטליים מתקדמים מאפשרים לנו להוביל מהלכים תקשורתיים חכמים וממוקדים.",
    image: "/images/tech-data.jpg",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
