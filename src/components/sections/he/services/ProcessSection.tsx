...
const processes = [
  {
    number: "01",
    title: "פגישת היכרות",
    description: "נבין את המטרות והאתגרים שלך, ננתח את המצב הנוכחי ונזהה הזדמנויות לשיפור ולמינוף תקשורתי.",
    icon: (
  ...
  {
    number: "02",
    title: "בניית תוכנית אסטרטגית",
    description: "נפתח תוכנית ממוקדת עם פתרונות מותאמים אישית, תוך איזון בין הצרכים, היעדים והמשאבים שלך.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    number: "03",
    title: "יציאה לפעולה",
    description: "נבצע את התוכנית תוך עדכונים שוטפים ושקיפות מלאה, כך שתוכל לראות את ההתקדמות בזמן אמת.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    number: "04",
    title: "תוצאות ומדידה",
    description: "ננתח את ההשפעה, נבצע התאמות לפי הצורך, ונראה איך המהלכים שלנו מקדמים את הצמיחה שלך.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {processes.map((process, index) => (
              ...
              >
                ...
                {index < processes.length - 1 && (
                  <motion.div 
                    className="hidden lg:block absolute top-8 right-[60%] left-0 h-px bg-gradient-to-l from-black-900/20 to-transparent"
                    initial={{ scaleX: 0 }}
                ...
                <div className="relative p-8 rounded-lg bg-white shadow-sm border border-black-900/5 hover:border-black-900/10 transition-all duration-300">
                  ...
                  <motion.div 
                    ...
                    className="absolute -top-4 right-8 bg-black-900 text-silver-100 text-sm font-montserrat tracking-wider px-3 py-1 rounded"
                  >
                    {process.number}
                  </motion.div>
                  ...
                  {/* Bottom Accent */}
                  <motion.div 
                    className="absolute bottom-0 right-0 left-0 h-px bg-gradient-to-l from-transparent via-black-900/10 to-transparent"
                    initial={{ scaleX: 0 }}
                    whileHover={{ scaleX: 1 }}
