          ...
          >
            ...
            >
              <Button
                ...
                aria-label="התחבר למיכאל ימיני בלינקדאין"
              >
                בוא נתחבר בלינקדאין
                <svg className="w-5 h-5 mr-2 transition-transform group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
