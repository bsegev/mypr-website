        ...
        >
          ...
          >
            ...
            <p className="text-lg md:text-xl text-black-900/60 font-inter font-light max-w-2xl mx-auto">
              מעוניינים לשמוע עוד על הדרך שלי, השיטות שלי, או איך אני יכול לעזור לארגון שלכם?
            </p>
          </motion.div>
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-body md:text-body-lg text-black-900/60 font-inter font-light">
                  בואו נדבר על המטרות התקשורתיות שלכם ונבחן כיצד נוכל לעבוד יחד.
                </p>
                <Button 
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-black-900/60 font-inter font-light">
                  התחברו איתי בלינקדאין לעדכונים ותובנות בתחום יחסי הציבור.
                </p>
                <Button
                  ...
                  aria-label="התחברו למיכאל בלינקדאין"
                >
