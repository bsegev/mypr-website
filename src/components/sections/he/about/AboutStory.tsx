...
const storyPoints = [
  {
    id: 1,
    title: "מומחיות מוכחת",
    description: "ניסיון מעשי ואינטנסיבי בעבודה עם דמויות בכירות בפוליטיקה הישראלית, מותגים מובילים וארגונים גדולים.",
    icon: (
  ...
  },
  {
    ...
    description: "ניהול קמפיינים בולטים, פתרון משברי תקשורת מאתגרים והובלת מהלכים אסטרטגיים במשרדי יח״צ מובילים ותפקידי ניהול דיגיטל בכירים.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    id: 3,
    title: "מסע עצמאי",
    description: "יצאתי לדרך עצמאית כדי לספק לבעלי עסקים, מנכ״לים ומנהלי תקשורת פתרונות מותאמים אישית, מדויקים ומעשיים.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Container>
        ...
        >
          ...
          <p className="text-lg md:text-xl font-inter font-light text-black-900/60 max-w-2xl mx-auto">
            MYPR – השותף שלך לייעוץ אסטרטגי ודיגיטלי
          </p>
        ...
        <TracingBeam className="px-4 md:px-8">
          <div 
            ...
            role="list"
            aria-label="אבני דרך במסע המקצועי"
          >
            {storyPoints.map((point, index) => (
              <motion.div
                ...
                className="relative pr-10 md:pr-16"
                role="listitem"
              >
                <div 
                  className="absolute right-0 top-1 flex items-center justify-center w-8 h-8 rounded-full bg-black-900 text-silver-100"
                  aria-hidden="true"
                >
                  {point.icon}
                </div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="relative pr-10 md:pr-16 pt-8 border-t border-black-900/10"
              role="contentinfo"
              aria-label="הצהרת חזון"
            >
              <div 
                className="absolute right-0 top-[calc(2rem+1px)] flex items-center justify-center w-8 h-8 rounded-full bg-black-900 text-silver-100"
                aria-hidden="true"
              >
              ...
              <div className="space-y-3">
                ...
                <p className="text-base text-black-900/70 font-inter font-light leading-relaxed">
                  אני מעצים מנהיגים לתקשר בבהירות, לנהל משברים ביעילות ולבנות אמון ציבורי מתמשך.
                  ב-MYPR, אני מאמין שכל אתגר הוא הזדמנות לצמיחה – ואני מחויב להפוך את ההזדמנות הזו ליתרון אסטרטגי עבור העסק שלך.
                </p>
              </div>
            </motion.div>
          </div>
