...
const values = [
  {
    ...
    description: "Direct, transparent dialogue that builds trust and drives results.",
    icon: (
  ...
  },
  {
    ...
    description: "Turning challenges into opportunities through careful analysis and planning.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Tailored, one-on-one solutions that address your unique challenges.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: "Crisis Expertise",
    description: "Proven ability to navigate and resolve challenging media situations.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Focus on delivering measurable impact and strategic advantage.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Building lasting relationships through reliability and excellence.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
