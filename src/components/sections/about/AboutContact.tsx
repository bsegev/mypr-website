    ...
    <section ref={sectionRef} className="relative py-32 bg-silver-100">
      ...
      <Container>
        ...
        >
          ...
          >
            <h2 className="text-4xl md:text-5xl font-montserrat font-light tracking-wide text-black-900">
              Get to Know Me
            </h2>
          ...
          >
            {/* Consultation Card */}
            <div className="group relative p-8 rounded-lg bg-white border border-black-900/5 hover:border-black-900/10 transition-colors">
          ...
          >
            <div className="text-black-900/40 font-inter text-sm">
